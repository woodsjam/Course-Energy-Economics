...
This text will be heavily supplemented with material from the Energy Information Administration (EIA) https://www.eia.gov/, the texbook authors website (http://dahl.mines.edu/), and journal articles available electronically through the library.
...
Teams will be assigned by the instructor during the first week of class. They will be composed of at least one
...
available for the class to review by DATE3 and should be provided in “Final Abstracts” discussion topic.  Here are some links on how to create an annotated bibiography () http://guides.library.cornell.edu/annotatedbibliography and https://www.bethel.edu/library/research/apa-annobib-sixth.pdf) so you can see some examples before you start.
...
6. The final paper must be published to the “Final Papers” discussion topic by DATE6. Term papers
must be less than 20 pages.

## Referee Reports

A referee report is a critical examination of an academic paper.  There is a split in their purpose, help the editor make a determination or help the author, but in either case, you typically make the deepest read of an acdemic paper when you review it.  The official guidance from the AEA is (https://www.aeaweb.org/content/file?id=222) but there is some more detailed guidance here that is more helpful to authors (=http://are.berkeley.edu/courses/ARE251/2004/assignments/RRGuidelines.pdf)
