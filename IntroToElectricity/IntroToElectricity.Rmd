...
+ The revenue requirement (RR) must be satisfied by the pricing system.      + Why the simple versions with a single price is P = AC.
...
+ Most commonly the RR:
    ...
    + Has a target return on capital, r, which is known to attract capital and compensate investors for risks.
...
+ This is the A-J effect.
    ...
    + The rate of return, r, does not increase but if you increase RB your revenue increases and your profit, i.e., net income increases.
...
+ What about r?
    + r is actually more than one number.
...
Yardstick competition (Shliefer 1985).  Don't use the firm's own costs, use the costs of an identical firm elsewhere.
